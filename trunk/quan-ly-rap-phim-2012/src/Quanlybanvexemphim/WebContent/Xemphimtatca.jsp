...
<form action="Xemphimtatca.jsp" method="post"">
<%
...
<table border="1" width="70% ">
  ...
  int x = 1;
  if ("tim kiem".equals(request.getParameter("bttimkiem"))) {
   ...
   sql8 ="select MaPhim,AnhDaiDien,MoTaPhim from Phim,LoaiPhim,QuocGia where ((Phim.MaLoaiPhim = LoaiPhim.MaLoaiPhim and Phim.MaQuocGia=QuocGia.MaQuocGia)and( Phim.MaQuocGia like '"+ quocgia + "' or Phim.MaLoaiPhim like '"+ theloai + "'or TenPhim like '"+ tenphim + "' ))";
   ...
   { 
	...
	<tr>
		...
		<% }%>
		<td width=400>
		<fieldset><legend> <font color="navy">Tìm
		kiếm </font></legend>
		<div align="center">
		<table>
			<tr>
	 ...
	 String sel ="SELECT MaPhim,[AnhDaiDien],[MoTaPhim] FROM (SELECT ROW_NUMBER() OVER (ORDER BY Phim.MaPhim DESC)AS Row, MaPhim,[AnhDaiDien],[MoTaPhim] FROM Phim)AS LogWithRowNumbers WHERE Row >= "+p+" AND Row < "+p_one+"";
