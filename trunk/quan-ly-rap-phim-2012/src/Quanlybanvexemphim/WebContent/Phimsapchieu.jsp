...
<form action="Phimsapchieu.jsp" method="post">
...
String sql9 = "SELECT phim.maphim,phim.anhdaidien, phim.tenphim, "
    ...
    + " WHERE ( NgayChieu >= dateadd(dd,7,getdate())) ";
...
if ("".equals(tenphim) == false) {
    ...
    %>    
         <tr class="ourCompany-list"><td width=300 align="center"><a href="Chitietphim.jsp?mphim=<%=rs9.getString(1)%>" target="_blank">
             <img src="<%out.println(rs9.getString(2)); %>" width="300" height="450"></img>
            </a></td>
             <td colspan= 3 align="left">
           <font face="Arial " color="black" size="2"> Tên phim:<%out.println(rs9.getString(3));%> </font> <br>
               Thời lượng:<%out.println(rs9.getString(4));%>giờ<%out.println(rs9.getString(5));%> <br>
               Thể loại: <%out.println(rs9.getString(8));%> <br>
               Ngày chiếu:<%out.println(rs9.getString(6));%> <br>
               Mô tả phim:<%out.println(rs9.getString(7));%> <br>
     ...
     %>  
        ...
        <td colspan =3>
         <br><br> <br> <br> 
    <fieldset> <legend>  <font face="Arial " color="black" size="5">Tìm kiếm </font></legend>
        <div align="center">
        <table width=100%>
            <tr  class="ourCompany-list">
            <td align="left">Dạng phim:</td>
                <td>
            <select name="dangphim" style="width: 150px; height: 18px;">
                   <%  
             ...
             <tr  class="ourCompany-list">
                ...
                <td align="left">Ngày chiếu:</td>
                 ...
                 <select name="thang" style="width: 60px; height: 18px;">
                   <option value="">chọn</option>
                          <% for (int i=1;i<=12;i++){
                          %><option value=<%=i%>><%=i%> </option><%
                            }%>
                        </select>
                 <select name="nam" style="width: 60px; height: 18px;">
                 <option value="">chọn</option>
                ...
                <tr  class="ourCompany-list"> <td align="left">Giá vé</td>
                 <td><input type="text" size ="10" name="gia"> <label>000vnd</label></td></tr>
                 <tr  class="ourCompany-list"><td  align="left">Tên phim:</td>
                    <td><input type="text" size="30" name="tenphim"></td> </tr>
                <tr  class="ourCompany-list"><td align="right"><center><input type ="submit"name="bttimkiem" value="Tìm kiếm"></center></td></tr>
...
{
	 	    String sel ="select top 2 * from ( select top "+p_one+" phim.maphim,anhdaidien, phim.tenphim, phim.dodaigio, phim.dodaiphut, lichchieu.ngaychieu, phim.motaphim, loaiphim.tenloaiphim from lichchieu inner join xuatchieu on xuatchieu.maxuatchieu = lichchieu.Maxuatchieu inner join phim on xuatchieu.maphim = phim.maphim inner join loaiphim on phim.maloaiphim = loaiphim.maloaiphim where NgayChieu>= dateadd(dd,7,getdate())order by ngaychieu asc ) a order by a.ngaychieu desc";
	    ...
	    while(pt.next())
	    {
	        ...
	        <tr class="ourCompany-list">
	            <td width=300 align="center"><a href="Chitietphim.jsp?mphim=<%=pt.getString(1)%>" target="_blank">
	             <img src="<%out.println(pt.getString(2)); %>" width="300" height="450"></img>
	            </a></td>
	             <td colspan= 3 align="left">
	           <font face="Arial " color="black" size="2">Tên phim: <%out.println(pt.getString(3));%> </font> <br>
	               Thời lượng:<%out.println(pt.getString(4));%>giờ<%out.println(pt.getString(5));%> <br>
                   Thể loại: <%out.println(pt.getString(8));%> <br>
                   Ngày chiếu:<%out.println(pt.getString(6));%> <br>
	               Mô tả phim:<%out.println(pt.getString(7));%> <br>
                ...
                <select name="dangphim" style="width: 150px; height: 18px; ">
                 ...
                 <tr  class="ourCompany-list">
                    ...
                    <td align="left">Ngày chiếu:</td>
                     ...
                     <select name="thang" style="width: 50px; height: 18px; ">
                       <option value="">Tất cả</option>
                              <% for (int i=1;i<=12;i++){
                              %><option value=<%=i%>><%=i%> </option><%
                                }%>
                            </select>
                     <select name="nam" style="width: 50px; height: 18px; ">
                     <option value="">chọn</option>
                         <% for (int i=2012;i<=2030;i++){
                          %><option value=<%=i%>><%=i%> </option><%
                         }%>
                    ...
                    <tr  class="ourCompany-list"> <td align="left">Giá vé</td>
                     <td><input type="text"  width=150 name="gia"> </td><td><label>000vnd</label></td></tr>
                     <tr  class="ourCompany-list"><td  align="left">Tên phim:</td>
                        <td><input type="text" width=150 name="tenphim"></td> </tr>
                    <tr  class="ourCompany-list"><td align="right"><center><input type ="submit"name="bttimkiem" value="Tìm kiếm"></center></td></tr>
