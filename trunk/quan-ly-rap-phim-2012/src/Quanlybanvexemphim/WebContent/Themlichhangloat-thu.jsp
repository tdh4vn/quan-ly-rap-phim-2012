...
<form action="Themlichhangloat-thu.jsp">
<table  width="100%" >
	...
	<tr>
		...
		<table width="100%">
			...
			<tr>
				...
				<fieldset><legend> <font size="5" >Thêm lịch chiếu hàng loạt</font></legend>
				<table>
...
<!--						          			<td><select name="maPhim<%=maPhong.get(i) %>">-->
							...
							%>
							    				 ...
							    				 <td><%=gio%>h<input type="text" name="phutChieu<%=maPhong.get(i)%>"
						...
						<%
							...
							%>
										...
										<td><%=gio%>h<input type="text" name="phutChieu<%=maPhong.get(i) %>" value=""
										style="width: 18px;"></td>
                        <%     			 } //if 
