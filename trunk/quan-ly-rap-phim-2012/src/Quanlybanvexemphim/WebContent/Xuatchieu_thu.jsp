...
while(rs2.next()){%>
			...
			<tr class="ourCompany-list1">
				...
				<td align=center><a href=""
					onclick="chuyenManHinh('Datve2.jsp?<%=session.getAttribute ("maPhim3")%>&<%=session.getAttribute("ngayChieuAttribute")%>')"><font
					face=" Arial " color="333333"><%=rs2.getString(1) %>h<%=rs2.getString(2)%></font></a>
				</td>
