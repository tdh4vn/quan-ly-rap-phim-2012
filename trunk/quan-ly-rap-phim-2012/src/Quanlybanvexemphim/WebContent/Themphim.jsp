...
<table width="100%">
	...
	<tr>
		<td colspan="11">
		<fieldset><legend><font face="Arial " color="black" size="5"> Thêm
		phim</font></legend>
		<div align="center">
		<table>
			<tr class="ourCompany-list">
				...
				<td></td>
				<td align="left"><input type="text" size="30" name="MaPhim" id="Maphimtxt" />
			...
			<tr class="ourCompany-list">
				...
				<td></td>
				<td align="left"><input type="text" size="30" name="TenPhim" id="Tenphimtxt" />
			...
			<tr class="ourCompany-list">
		<td colspan="3" align="center"><input type="submit" name="btthem"
			value="Thêm" onclick="return Kiemtrathemphim();"></td>
	</tr>
	<tr> <td colspan="3"> <font color ="red">*</font> <font color = "#951509" face="Arial Narrow" size="3"> Thông tin bắt buộc phải điền. </font></td> </tr>
		</table>
		</div>
		</fieldset>
		</td>
