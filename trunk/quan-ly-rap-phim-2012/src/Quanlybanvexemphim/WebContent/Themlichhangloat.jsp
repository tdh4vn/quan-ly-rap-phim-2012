...
<form action="Themlichhangloat.jsp">
<br> <br> <br>  <br> <br>
<table  width="100%" >
	...
	<tr>
		...
		<table width="100%">
			<tr>
				<td colspan="10" align="right">Hello <%=session.getAttribute("tenDangNhap")%>


				</td>
			</tr>
			<tr> <td> <h2 class="ourCompany-hdr">Thêm lịch hàng loạt</h2> </td> </tr>

			<tr>
				<td colspan="10" align="center">
				<fieldset><legend> <font face="Arial " color="black" size="5">Chọn ngày</font></legend>
				<table>
					...
					<tr>
						...
						<td colspan="2" align="center" ><input
							type="submit" name="btnThemLichHangLoat" value="Thêm lịch hàng loạt" onclick="return kiemTraTimKiem()"></td>
					</tr>
					<tr>
						<!--THONG BAO LOI					-->
...
<!--						          			<td><select name="maPhim<%=maPhong.get(i) %>">-->
							...
							%>
							    				 ...
							    				 <td><font color="#47481A"><%=gio%>h</font><input type="text" name="phutChieu<%=maPhong.get(i)%>"
														value="<%=rs3.getString(4)%>" style="width: 18px;"></td>
						...
						<%
							...
							%>
										...
										<td><font color="#47481A"><%=gio%>h</font><input type="text" name="phutChieu<%=maPhong.get(i) %>" value=""
										style="width: 18px;"></td>
                        <%     			 } //if 
